const mudar = document.getElementById("mudar")
        ...
        // ]
        let coisas = [
            ["Um número", "Um botão","Um lugar para guardar um valor","Uma imagem","O que é uma variável?"],//pergunta,alternativa1,alternativa2,alternativa3,alternativa4
            ["Parar o programa", "Fazer uma conta","Mostrar algo na tela","Apagar algo","Para que serve o comando print em programação?"],
            ["Um vídeo", "Um site","Um conjunto de comandos","Um erro","O que é um programa?"],
            ["10", "'texto'","5.5","verdadeiro","Qual destes é um float"],
            ["texto", "nuemro","booleano","soma","Qual o tipo de dado que pode ser 'verdadeiro' ou 'falso'"],
            ["repetir algo", "mostrar algo na tela","fazer uma escolha","guardar dados","Para que serve o if"],
        ]
