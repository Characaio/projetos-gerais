...
const mudar = document.getElementById("mudar")
        ...
        // ]
        let coisas = [
        ["Blank Space", "You Belong With Me", "All Too Well", "Style", "Em qual música Taylor Swift faz referência direta a uma 'scarf' (cachecol), que virou um dos maiores símbolos entre os fãs?"],
        ["Toxic", "Teenage Dream", "Like a Virgin", "Shake It Off", "Qual hit da Madonna foi um dos maiores sucessos dos anos 80?"],
        ["Piece Of Me", "Oops!... I Did It Again", "Baby One More Time", "Circus", "Qual foi o primeiro grande hit da Britney Spears?"],
        ["Born This Way", "Applause", "Shallow", "Rain On Me", "Qual dessas músicas rendeu a Lady Gaga um Oscar?"],
        ["Swish Swish", "E.T", "Dark Horse", "Wide Awake", "Qual dessas músicas de Katy Perry teve um clipe com visual inspirado no Egito Antigo?"]
      ];
